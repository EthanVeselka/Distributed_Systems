 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::snsCoordinator::Users* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>> AsyncGetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>>(AsyncGetAllUsersRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>> PrepareAsyncGetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>>(PrepareAsyncGetAllUsersRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      virtual void GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>* AsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::snsCoordinator::Users>* PrepareAsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::snsCoordinator::Users* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>> AsyncGetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>>(AsyncGetAllUsersRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>> PrepareAsyncGetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>>(PrepareAsyncGetAllUsersRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, std::function<void(::grpc::Status)>) override;
      void GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>* AsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>* PrepareAsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status GetAllUsers(::grpc::ServerContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response);
  };
  ...
  class WithAsyncMethod_GetAllUsers : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetAllUsers(::grpc::ServerContext* /*context*/, const ::snsCoordinator::ClusterId* /*request*/, ::snsCoordinator::Users* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetAllUsers(::grpc::ServerContext* context, ::snsCoordinator::ClusterId* request, ::grpc::ServerAsyncResponseWriter< ::snsCoordinator::Users>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(4, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_HandleHeartBeats<WithAsyncMethod_GetFollowSyncsForUsers<WithAsyncMethod_GetServer<WithAsyncMethod_GetSlave<WithAsyncMethod_GetAllUsers<Service > > > > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_GetAllUsers() {
      ::grpc::Service::MarkMethodCallback(4,
          new ::grpc::internal::CallbackUnaryHandler< ::snsCoordinator::ClusterId, ::snsCoordinator::Users>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response) { return this->GetAllUsers(context, request, response); }));}
    void SetMessageAllocatorFor_GetAllUsers(
        ::grpc::MessageAllocator< ::snsCoordinator::ClusterId, ::snsCoordinator::Users>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(4);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::snsCoordinator::ClusterId, ::snsCoordinator::Users>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetAllUsers(
      ::grpc::CallbackServerContext* /*context*/, const ::snsCoordinator::ClusterId* /*request*/, ::snsCoordinator::Users* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_HandleHeartBeats<WithCallbackMethod_GetFollowSyncsForUsers<WithCallbackMethod_GetServer<WithCallbackMethod_GetSlave<WithCallbackMethod_GetAllUsers<Service > > > > > CallbackService;
   ...
   public:
    WithStreamedUnaryMethod_GetAllUsers() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler<
          ::snsCoordinator::ClusterId, ::snsCoordinator::Users>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::snsCoordinator::ClusterId, ::snsCoordinator::Users>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetAllUsers(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::snsCoordinator::ClusterId,::snsCoordinator::Users>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_GetFollowSyncsForUsers<WithStreamedUnaryMethod_GetServer<WithStreamedUnaryMethod_GetSlave<WithStreamedUnaryMethod_GetAllUsers<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetFollowSyncsForUsers<WithStreamedUnaryMethod_GetServer<WithStreamedUnaryMethod_GetSlave<WithStreamedUnaryMethod_GetAllUsers<Service > > > > StreamedService;
};
