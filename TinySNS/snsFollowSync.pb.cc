...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_snsFollowSync_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::snsFollowSync::Reply, all_users_),
  PROTOBUF_FIELD_OFFSET(::snsFollowSync::Reply, following_users_),
};
...
const char descriptor_table_protodef_snsFollowSync_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ll_users\030\002 \003(\t\022\027\n\017following_users\030\003 \003(\t2"
  "\311\001\n\rSNSFollowSync\0229\n\tSyncUsers\022\024.snsFoll"
  "owSync.Users\032\024.snsFollowSync.Reply\"\000\022@\n\r"
  "SyncRelations\022\027.snsFollowSync.Relation\032\024"
  ".snsFollowSync.Reply\"\000\022;\n\014SyncTimeline\022\023"
  ".snsFollowSync.Post\032\024.snsFollowSync.Repl"
  "y\"\000b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_snsFollowSync_2eproto = {
  false, false, 531, descriptor_table_protodef_snsFollowSync_2eproto, "snsFollowSync.proto", 
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ...
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "snsFollowSync.Reply.all_users"));
            CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ...
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "snsFollowSync.Reply.following_users"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* Reply::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_following_users_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "snsFollowSync.Reply.following_users");
