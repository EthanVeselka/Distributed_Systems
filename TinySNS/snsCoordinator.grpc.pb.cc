...
static const char* SNSCoordinator_method_names[] = {
  ...
  "/snsCoordinator.SNSCoordinator/GetAllUsers",
};
...
SNSCoordinator::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_GetAllUsers_(SNSCoordinator_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status SNSCoordinator::Stub::GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::snsCoordinator::Users* response) {
  return ::grpc::internal::BlockingUnaryCall< ::snsCoordinator::ClusterId, ::snsCoordinator::Users, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetAllUsers_, context, request, response);
}

void SNSCoordinator::Stub::async::GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::snsCoordinator::ClusterId, ::snsCoordinator::Users, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAllUsers_, context, request, response, std::move(f));
}

void SNSCoordinator::Stub::async::GetAllUsers(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>* SNSCoordinator::Stub::PrepareAsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::snsCoordinator::Users, ::snsCoordinator::ClusterId, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetAllUsers_, context, request);
}

::grpc::ClientAsyncResponseReader< ::snsCoordinator::Users>* SNSCoordinator::Stub::AsyncGetAllUsersRaw(::grpc::ClientContext* context, const ::snsCoordinator::ClusterId& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
SNSCoordinator::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSCoordinator::Service, ::snsCoordinator::ClusterId, ::snsCoordinator::Users, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSCoordinator::Service* service,
             ::grpc::ServerContext* ctx,
             const ::snsCoordinator::ClusterId* req,
             ::snsCoordinator::Users* resp) {
...
::grpc::Status SNSCoordinator::Service::GetAllUsers(::grpc::ServerContext* context, const ::snsCoordinator::ClusterId* request, ::snsCoordinator::Users* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
